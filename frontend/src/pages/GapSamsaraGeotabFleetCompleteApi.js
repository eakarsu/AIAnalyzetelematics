...
// v0 scaffold for: Samsara, Geotab, and Fleet Complete API connectors
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-samsara-geotab-fleet-complete-api/run.

export default function SamsaraGeotabFleetCompleteApiPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-samsara-geotab-fleet-complete-api/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Samsara, Geotab, and Fleet Complete API connectors</h1>
