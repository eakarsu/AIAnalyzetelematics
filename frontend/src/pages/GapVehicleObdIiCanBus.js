...
// v0 scaffold for: No vehicle OBD-II / CAN-bus ingestion
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-vehicle-obd-ii-can-bus/run.

export default function VehicleObdIiCanBusPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-vehicle-obd-ii-can-bus/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No vehicle OBD-II / CAN-bus ingestion</h1>
